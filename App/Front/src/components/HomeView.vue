...
<h3 class="text-2xl text-green-600 mt-6 mb-6">Vælg venligst en fil</h3>
<h3 class="text-1xl text-green-600 mt-6 mb-12" v-if="MunddrikStore.AllMessage.length">Fil: {{ MunddrikStore.CurrentFile }} er blevet hentet</h3>
